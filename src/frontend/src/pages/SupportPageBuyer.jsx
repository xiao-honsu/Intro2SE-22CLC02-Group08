...
import '../styles/SupportPageBuyer.scss';

function SupportPageBuyer() {
    ...
    return (
        <div className="main-container">
            ...
            <div className="content-container">
                ...
                <div className="subtitle">Sales guidance</div>
                ...
                <div className="subtitle">Buyer protection policy</div>
                <div className="content">
...
export default SupportPageBuyer;